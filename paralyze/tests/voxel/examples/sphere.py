...
import PydroSquid.gui.voxel.core as vcore
import PydroSquid.gui.voxel.app as vapp
...
class VoxelApp(vapp.App):
    def __init__(self):
        config = vapp.Config(yaml.load("""
            app:
                window:
                    height: 600
                    width: 800
        ...
        # Create the renderer
        renderer = vcore.Renderer(program, (window.width, window.height))
