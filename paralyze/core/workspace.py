...
class Workspace(object):
    ...
    def __init__(self, path=None, auto_create=False, settings=None, log_level=logging.INFO, main_logger=None):
        ...
        # init main logger
        self.init_logger(log_level, main_logger)
    ...
    def init_logger(self, level=logging.DEBUG, main_logger=None):
    ...
    def init_variables(self, args=None):
        ...
        ----------
        args: dict or list
            A dict with variable names as keys or a list of command line arguments.

        Returns
        -------
        custom_args: dict or list
            The list of unused command line arguments if args is a list or an empty list if args is a dict.
        """
